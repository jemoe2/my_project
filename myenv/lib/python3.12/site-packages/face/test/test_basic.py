...
from face.utils import format_flag_label, get_minimal_executable, identifier_to_flag
...
def test_flag_name():
    ...
    name_err_map = {
        ...
        "name_": "without trailing dashes or underscores",
        "name--": "without trailing dashes or underscores",
        "n?me": "must begin with a letter.*and" " consist only of letters, digits, underscores, and" " dashes",
...
def test_minimal_exe():
    ...
    res = get_minimal_executable(
        venv_exe_path,
        environ={
            "PATH": "/home/mahmoud/bin:/usr/local/sbin" ":/usr/local/bin:/usr/sbin" ":/usr/bin:/sbin:/bin:/snap/bin"
        },
    )
...
def test_bad_subprs():
    with pytest.raises(ValueError, match="commands accepting positional arguments cannot take subcommands"):
