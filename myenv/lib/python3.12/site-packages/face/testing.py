...
class RunResult(object):
    ...
    def stdout(self):
        ...
        """
        return self.stdout_bytes.decode(self.checker.encoding, "replace").replace("\r\n", "\n")
    ...
    def stderr(self):
        ...
        return self.stderr_bytes.decode(self.checker.encoding, "replace").replace("\r\n", "\n")
...
class CommandChecker(object):
    ...
    def _isolate(self, input=None, env=None, chdir=None):
        ...
        if PY2:
            ...
            tmp_stdout = io.TextIOWrapper(bytes_output, encoding=self.encoding)
            if self.mix_stderr:
                tmp_stderr = tmp_stdout
            else:
                bytes_error = io.BytesIO()
                tmp_stderr = io.TextIOWrapper(bytes_error, encoding=self.encoding)
    ...
    def __getattr__(self, name):
        ...
        try:
            ...
            raise AttributeError("fail_* shortcuts must end in integers, not %r" % code_str)
    ...
    def run(self, args, input=None, env=None, chdir=None, exit_code=0):
        ...
        if exit_code is None:
            ...
            raise TypeError(
                "expected exit_code to be None, int, or"
