...
class TracesData(google.protobuf.message.Message):
    ...
    def resource_spans(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ResourceSpans]:
...
class ScopeSpans(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["schema_url", b"schema_url", "scope", b"scope", "spans", b"spans"]
    ) -> None: ...
