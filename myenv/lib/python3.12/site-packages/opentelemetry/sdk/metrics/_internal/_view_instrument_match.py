...
class _ViewInstrumentMatch:
    def __init__(
        ...
        if not isinstance(self._view._aggregation, DefaultAggregation):
            self._aggregation = self._view._aggregation._create_aggregation(self._instrument, None, 0)
        else:
    ...
    def conflicts(self, other: "_ViewInstrumentMatch") -> bool:
        ...
        if isinstance(self._aggregation, _SumAggregation):
            result = (
                result
                and self._aggregation._instrument_is_monotonic == other._aggregation._instrument_is_monotonic
