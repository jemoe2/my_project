...
def _import_config_components(selected_components: List[str], entry_point_name: str) -> Sequence[Tuple[str, object]]:
    ...
    for selected_component in selected_components:
        try:
            ...
            raise RuntimeError(
                f"Requested component '{selected_component}' not found in " f"entry point '{entry_point_name}'"
            )
