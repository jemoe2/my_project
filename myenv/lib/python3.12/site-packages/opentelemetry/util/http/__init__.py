        ...
        if header_regexes:
            ...
            for header_name in list(
                ...
                if header_values:
                    ...
                    values[key] = [self.sanitize_header_value(header=header_name, value=header_values)]
...
def get_traced_request_attrs(instrumentation):
    ...
    if traced_request_attrs:
        traced_request_attrs = [traced_request_attr.strip() for traced_request_attr in traced_request_attrs.split(",")]
