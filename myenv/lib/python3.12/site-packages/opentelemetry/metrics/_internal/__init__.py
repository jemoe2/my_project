...
class Meter(ABC):
    ...
    def _is_instrument_registered(self, name: str, type_: type, unit: str, description: str) -> Tuple[bool, str]:
        """
...
class NoOpMeter(Meter):
    ...
    def create_counter(
        ...
        if self._is_instrument_registered(name, NoOpCounter, unit, description)[0]:
            _logger.warning(
                "An instrument with name %s, type %s, unit %s and " "description %s has been created already.",
                name,
                Counter.__name__,
                unit,
                description,
...
def get_meter_provider() -> MeterProvider:
    ...
    if _METER_PROVIDER is None:
        ...
        meter_provider: MeterProvider = _load_provider(OTEL_PYTHON_METER_PROVIDER, "meter_provider")  # type: ignore
