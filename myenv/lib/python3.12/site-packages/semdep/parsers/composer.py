...
def get_manifest_deps(parsed_manifest: Optional[JSON]) -> Set[str]:
    if not parsed_manifest:
        ...
        manifest_deps = set(manifest_json["require"].as_dict().keys()) if "require" in manifest_json else set()
...
def parse_composer_lock(
    ...
    parsed_lockfile, parsed_manifest, errors = safe_parse_lockfile_and_manifest(
        ...
        DependencyFileToParse(manifest_path, json_doc, ScaParserName(ComposerLock_())) if manifest_path else None,
    )
