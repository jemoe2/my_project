...
class Iter(object):
    ...
    def map(self, subspec):
        ...
        *subspec* to each element of the iterable.
        ...
        return self._add_op(
            "map", (subspec,), lambda iterable, scope: imap(lambda t: scope[glom](t, subspec, scope), iterable)
        )
    ...
    def filter(self, key=T):
        ...
        return self._add_op(
            "filter",
            (key,),
            lambda iterable, scope: ifilter(lambda t: scope[glom](t, check_spec, scope) is not SKIP, iterable),
        )
    ...
    def split(self, sep=None, maxsplit=None):
        ...
        *sep* is ``None``, ``split()`` **groups** separators. If empty lists
        ...
        """
        return self._add_op("split", (sep, maxsplit), lambda it, scope: split_iter(it, sep=sep, maxsplit=maxsplit))
    ...
    def unique(self, key=T):
        ...
        """
        return self._add_op(
            "unique", (key,), lambda it, scope: unique_iter(it, key=lambda t: scope[glom](t, key, scope))
        )
    ...
    def takewhile(self, key=T):
        ...
        *key* becomes falsy.
        ...
        """
        return self._add_op("takewhile", (key,), lambda it, scope: takewhile(lambda t: scope[glom](t, key, scope), it))
    ...
    def dropwhile(self, key=T):
        ...
        *key* becomes falsy.
        ...
        return self._add_op("dropwhile", (key,), lambda it, scope: dropwhile(lambda t: scope[glom](t, key, scope), it))
