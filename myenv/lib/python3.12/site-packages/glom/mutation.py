...
class PathDeleteError(PathAssignError):
    ...
    def get_message(self):
        return "could not delete %r on object at %r, got error: %r" % (self.dest_name, self.path, self.exc)
...
_UNASSIGNABLE_BASE_TYPES = tuple(set(_BUILTIN_BASE_TYPES) - set([dict, list, BaseException, object, type]))
