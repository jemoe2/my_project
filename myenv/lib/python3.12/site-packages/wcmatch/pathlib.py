...
from . import _wcparse, glob, util
    ...
    def globmatch(
        ...
        *,
        ...
        return glob.globmatch(
            self._translate_path(), patterns, flags=self._translate_flags(flags), limit=limit, exclude=exclude
        )
    ...
    def glob(  # type: ignore[override]
        ...
        *,
        ...
        if self.is_dir():
            ...
            flags = self._translate_flags(flags | _NOABSOLUTE) | (  # type: ignore[attr-defined]
