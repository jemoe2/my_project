...
class Terminal:
    ...
    def configure(
        ...
        *,
        ...
        stdout_handler = logging.StreamHandler(stream=sys.stderr if multiple_streams_available else sys.stdout)
    ...
    def configure_rich_console(self, quiet: bool, multiple_streams_available: bool) -> None:
        console.quiet = quiet
