...
class SarifFormatter(base.BaseFormatter):
    ...
    def _osemgrep_format(
        ...
        with exit_stack:
            rule_file = exit_stack.enter_context(tempfile.NamedTemporaryFile("w+", suffix=".json"))
            ...
            is_pro = bool(cli_output.engine_requested and cli_output.engine_requested == out.EngineKind(out.PRO_()))
    ...
    def format(
        ...
        output = base.to_CliOutput(rule_matches, semgrep_structured_errors, cli_output_extra)
