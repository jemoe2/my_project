...
from semgrep.constants import DEFAULT_MAX_MEMORY_PRO_CI, DEFAULT_PRO_TIMEOUT_CI
...
class EngineType(Enum):
    ...
    def decide_engine_type(
        ...
        if diff_scan and not interfile_diff_scan_enabled and requested_engine is cls.PRO_INTERFILE:
            requested_engine = cls.PRO_INTRAFILE
    ...
    @staticmethod
    def validate_requested_engine(run_secrets: bool, requested_engine: "EngineType") -> None:
