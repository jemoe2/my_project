...
class ScanInfoLogProcessor(LogRecordProcessor):
    ...
    def __init__(self: "ScanInfoLogProcessor", base_processor: LogRecordProcessor) -> None:
...
class Traces:
    ...
    def configure(self, enabled: bool, trace_endpoint: Optional[str]) -> None:
        ...
        env_name = _ENV_ALIASES.get(_DEFAULT_ENDPOINT if trace_endpoint is None else trace_endpoint)
        ...
        endpoint = _ENDPOINT_ALIASES.get(trace_endpoint, trace_endpoint) if trace_endpoint else _DEFAULT_ENDPOINT
    ...
    def inject(self) -> None:
        ...
        resource_attributes = ",".join(scan_info_kv + ([base_resource_attributes] if base_resource_attributes else []))
        ...
        os.environ[_SEMGREP_TRACE_PARENT_TRACE_ID] = otrace.format_trace_id(current_context.trace_id)
        os.environ[_SEMGREP_TRACE_PARENT_SPAN_ID] = otrace.format_span_id(current_context.span_id)
