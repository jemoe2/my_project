...
def maybe_set_git_safe_directories() -> None:
    ...
    try:
        ...
        logger.info(f"Semgrep failed to set the safe.directory Git config option. Git commands might fail: {e}")
...
def cli(ctx: click.Context) -> None:
    ...
    subcommand: str = ctx.invoked_subcommand if ctx.invoked_subcommand in commands else "unset"
