...
from typing import Collection, Mapping, NewType, Optional
...
class LanguageDefinition:
    ...
    def from_dict(cls, data: JsonObject) -> "LanguageDefinition":
        ...
        return cls(
            ...
            keys=data["keys"],
            exts=data["exts"],
            reverse_exts=data["reverse_exts"] if data["reverse_exts"] is not None else data["exts"],
...
class _LanguageData:
    def __init__(self) -> None:
        ...
        self.lang_by_key: Mapping[str, Language] = {
            key.lower(): lang for lang, definition in self.definition_by_id.items() for key in definition.keys
        }
        self.lang_by_ext: Mapping[str, Language] = {
            ext: lang for lang, definition in self.definition_by_id.items() for ext in definition.reverse_exts
        }
