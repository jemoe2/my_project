...
def format(formatter: out.OutputFormat, ctx: out.FormatContext, output: out.CliOutput) -> str:
...
def resolve_dependencies(
    ...
    ret: Optional[out.RetResolveDependencies] = rpc_call(call, out.RetResolveDependencies)
    if ret is None:
