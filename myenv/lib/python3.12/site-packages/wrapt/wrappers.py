...
class _FunctionWrapperBase(ObjectProxy):
    ...
    __slots__ = ("_self_instance", "_self_wrapper", "_self_enabled", "_self_binding", "_self_parent", "_self_owner")

    def __init__(self, wrapped, instance, wrapper, enabled=None, binding="callable", parent=None, owner=None):
    ...
    def __get__(self, instance, owner):
        ...
        if self._self_parent is None:
            ...
            return self.__bound_function_wrapper__(
                descriptor, instance, self._self_wrapper, self._self_enabled, self._self_binding, self, owner
            )
