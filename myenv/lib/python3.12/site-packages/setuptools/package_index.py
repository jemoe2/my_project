...
def parse_requirement_arg(spec):
    try:
        ...
        raise DistutilsError(f"Not a URL, existing file, or requirement spec: {spec!r}") from e
...
class PackageIndex(Environment):
    ...
    def process_index(self, url, page):
        ...
        return PYPI_MD5.sub(lambda m: '<a href="{}#md5={}">{}</a>'.format(*m.group(1, 3, 2)), page)
    ...
    def fetch(self, requirement, tmpdir, force_scan: bool = False, source: bool = False) -> str | None:
    ...
    def open_url(self, url, warning=None):  # noqa: C901  # is too complex (12)
        ...
        try:
            ...
            if warning:
                ...
                raise DistutilsError(f"{url} returned a bad status line. The server might be " f"down, {v.line}") from v
