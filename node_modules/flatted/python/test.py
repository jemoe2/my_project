...
if (
    stringify(a) != '[["0",1,"1",true,"2","3","4"],"two",{"o":"2","one":1,"two":"1","three":true,"a":"0","test":"3","array":"4"},{"test":"5"},[1,2,3],"OK"]'
):
    raise AssertionError
if (
    stringify(o) != '[{"o":"0","one":1,"two":"1","three":true,"a":"2","test":"3","array":"4"},"two",["2",1,"1",true,"0","3","4"],{"test":"5"},[1,2,3],"OK"]'
):
    raise AssertionError
...
if not (a2[1] == 1 and a2[2] == "two" and a2[3] == True and isinstance(a2[4], dict)):
    raise AssertionError
