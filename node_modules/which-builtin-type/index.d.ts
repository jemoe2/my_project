...
declare function whichBuiltinType<T>(
  value: Parameters<typeof whichCollection>[0],
): ReturnType<typeof whichCollection>;
declare function whichBuiltinType<T>(
  value: Parameters<typeof whichTypedArray>[0],
): ReturnType<typeof whichTypedArray>;
...
declare function whichBuiltinType<T>(
  value: T extends object ? WeakRef<T> : never,
): "WeakRef";
declare function whichBuiltinType<T>(
  value: FinalizationRegistry<T>,
...
declare function whichBuiltinType<T>(
  ...
  | "Object"
  | Exclude<ReturnType<typeof whichBoxedPrimitive>, null | undefined>
  | string;
