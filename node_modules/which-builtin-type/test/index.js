...
test("non-nullish", function (t) {
  ...
  var tests = {
    Number: [0, -0, 42, Infinity, -Infinity, NaN, 0.5],
    Boolean: [true, false],
    String: ["", "foo"],
    Date: [
      new Date(),
    ...
    RegExp: [/(?:)/, /a/g, assign(/constructor/, { constructor: Object })],
    Array: [[], [42], assign([], { constructor: Object })],
    Function: [
      function () {},
      function f() {},
    ...
    Object: /** @type {object[]} */ ([{}, { constructor: null }, Math]),
    Symbol: hasSymbols
      ? [
          Symbol.iterator,
          Symbol(),
      ...
      : [],
    BigInt: hasBigInts ? [BigInt(0), BigInt(42)] : [],
    Foo: [new F()],
    Map:
      typeof Map === "function"
        ? [
    ...
    WeakMap:
      typeof WeakMap === "function"
        ? [new WeakMap(), assign(new WeakMap(), { constructor: Object })]
        : [],
    Set:
      typeof Set === "function"
        ? [
    ...
    WeakSet:
      typeof WeakSet === "function"
        ? [new WeakSet(), assign(new WeakSet(), { constructor: Object })]
        : [],
    WeakRef:
      typeof WeakRef === "function"
        ? [new WeakRef({}), assign(new WeakRef({}), { constructor: Object })]
        : [],
  ...
  forEach(availableTypedArrays(), function (TypedArray) {
    ...
    tests[TypedArray] = [new global[TypedArray](0), new global[TypedArray](2)];
  });
  forEach(tests, function (values, expected) {
    forEach(values, function (value) {
      t.equal(
        which(value),
        expected,
        inspect(value) + " is " + inspect(expected),
      );
      ...
      if (value !== obj) {
        t.equal(
          which(obj),
          expected,
          inspect(obj) + " is " + inspect(expected),
        );
      }
      if (
        ...
        if (hasToStringTag) {
          ...
          t.equal(
            ...
            "Object",
            inspect(fakerTag) +
              " lies and claims it is a " +
              expected +
              ", but instead it is Object",
          );
        }
        ...
        var fakerConstructor = {
          // eslint-disable-next-line no-extra-parens
          constructor:
            global[/** @type {GlobalKey} */ (expected)] || tests[expected],
        };
        t.equal(
          which(fakerConstructor),
          "Object",
          inspect(fakerConstructor) +
            " lies and claims it is a " +
            expected +
            ", but instead it is Object",
        );
        ...
        if (hasToStringTag) {
          ...
          t.equal(
            ...
            "Object",
            inspect(fakerConstructorTag) +
              " lies with a tag and claims it is a " +
              expected +
              ", but instead it is Object",
          );
        }
