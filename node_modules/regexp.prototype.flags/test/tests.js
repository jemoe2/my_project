...
var sortedFlags = availableFlags
  .slice()
  .sort(function (a, b) {
...
module.exports = function runTests(flags, t) {
  ...
  t.equal(flags(/a/gim), "gim", 'flags(/a/gmi) !== "gim"');
  t.equal(
  ...
  t.test("sorting", function (st) {
    ...
    st.equal(flags(/a/gim), "gim", 'flags(/a/mig) !== "gim"');
    st.equal(flags(/a/gim), "gim", 'flags(/a/mgi) !== "gim"');
    ...
    var randomFlags = availableFlags
      .slice()
      .sort(function () {
  ...
  t.test("basic examples", function (st) {
    ...
    st.equal(flags(/a/gim), "gim", '(/a/gmi).flags !== "gim"');
    st.equal(
      flags(new RegExp("a", "gmi")),
      "gim",
