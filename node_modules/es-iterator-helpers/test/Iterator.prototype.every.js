...
module.exports = {
  tests: function (every, name, t) {
    ...
    forEach(v.primitives.concat(v.objects), function (nonIterator) {
      t["throws"](
        function () {
          iterate(every(nonIterator, function () {}));
        },
        TypeError,
      ...
      t["throws"](
        function () {
          iterate(every(badNext, function () {}));
        },
        TypeError,
    ...
    forEach(v.nonFunctions, function (nonFunction) {
      t["throws"](
        function () {
          every({ next: function () {} }, nonFunction);
        },
        TypeError,
    ...
    t.test("actual iteration", { skip: !hasSymbols }, function (st) {
      ...
      st["throws"](
        function () {
          return new every(iterator(), function () {});
        }, // eslint-disable-line new-cap
        TypeError,
        "`" + name + "` iterator is not a constructor",
      );
      ...
      st.equal(
        every(iterator(), function () {
          return false;
        }),
        false,
        "every for always-false",
      );
      st.equal(
        every(iterator(), function () {
          return true;
        ...
        true,
        "every for always-true",
      );
      st.equal(
        every(iterator(), function (x, i) {
          return x === 2 && i === 1;
        }),
        false,
        "every returns false for matching value/index",
      );
