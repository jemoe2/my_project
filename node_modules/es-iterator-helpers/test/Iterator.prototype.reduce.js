...
module.exports = {
  tests: function (reduce, name, t) {
    ...
    forEach(v.primitives.concat(v.objects), function (nonIterator) {
      t["throws"](
        function () {
          iterate(reduce(nonIterator, function () {}));
        },
        TypeError,
      ...
      t["throws"](
        function () {
          iterate(reduce(badNext, function () {}));
        },
        TypeError,
    ...
    forEach(v.nonFunctions, function (nonFunction) {
      t["throws"](
        function () {
          reduce({ next: function () {} }, nonFunction);
        },
        TypeError,
    ...
    t.test("actual iteration", { skip: !hasSymbols }, function (st) {
      ...
      st["throws"](
        function () {
          return new reduce(iterator(), function () {});
        }, // eslint-disable-line new-cap
        TypeError,
        "`" + name + "` iterator is not a constructor",
      );
      ...
      var results = [];
      var ret = reduce(iterator(), function (acc, x, i) {
