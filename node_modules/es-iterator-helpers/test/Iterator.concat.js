  ...
  tests: function (concat, name, t) {
    ...
    t.test("actual iteration", { skip: !hasSymbols }, function (st) {
      ...
      st.test("observability in a replaced String iterator", function (s2t) {
        ...
        var observedType;
        s2t.teardown(
          mockProperty(String.prototype, Symbol.iterator, {
            get: function () {
        ...
        s2t.equal(
          observedType,
          "string",
          "string primitive -> primitive receiver in Symbol.iterator getter",
        );
        concat(from(Object("")));
        s2t.equal(
          observedType,
          "object",
          "boxed string -> boxed string in Symbol.iterator getter",
        );
      ...
      st.test(
        "test262: test/built-ins/Iterator/concat/arguments-checked-in-order",
        ...
        function (s2t) {
          ...
          s2t["throws"](function () {
            concat(iterable1, null, iterable2);
          }, TypeError);
      ...
      st.test(
        "test262: test/built-ins/Iterator/concat/fresh-iterator-result",
        function (s2t) {
          var oldIterResult = {
            done: false,
            value: 123,
      ...
      st.test(
        "test262: test/built-ins/Iterator/concat/get-iterator-method-only-once",
        { skip: !hasPropertyDescriptors },
        function (s2t) {
          var iteratorGets = 0;
          var iteratorCalls = 0;
          ...
          Object.defineProperty(CountingIterable.prototype, Symbol.iterator, {
            get: function () {
              iteratorGets += 1;
          ...
          testIterator(
            ...
            array,
            s2t,
            "iterating over the iterator calls the iterator function once",
          );
      ...
      st.test(
        "test262: test/built-ins/Iterator/concat/get-iterator-method-throws",
        { skip: !hasPropertyDescriptors },
        function (s2t) {
          var iterable = {};
      ...
      st.test(
        "test262: test/built-ins/Iterator/concat/inner-iterator-created-in-order",
        function (s2t) {
          var calledIterator = [];
      ...
      st.test(
        "test262: test/built-ins/Iterator/concat/next-method-called-with-zero-arguments",
        function (s2t) {
          var nextCalled = 0;
      ...
      st.test(
        "test262: test/built-ins/Iterator/concat/next-method-returns-non-object",
        function (s2t) {
      ...
      st.test(
        "test262: test/built-ins/Iterator/concat/next-method-returns-throwing-done",
        { skip: !hasPropertyDescriptors },
        function (s2t) {
      ...
      st.test(
        "test262: test/built-ins/Iterator/concat/next-method-returns-throwing-value-done",
        { skip: !hasPropertyDescriptors },
        function (s2t) {
      ...
      st.test(
        "test262: test/built-ins/Iterator/concat/next-method-returns-throwing-value",
        { skip: !hasPropertyDescriptors },
        function (s2t) {
          var throwingIterator = {
            next: function () {
      ...
      st.test(
        "test262: test/built-ins/Iterator/concat/next-method-throws",
        function (s2t) {
          var throwingIterator = {
            next: function () {
              throw new EvalError();
      ...
      st.test(
        "test262: test/built-ins/Iterator/concat/return-is-not-forwarded-after-exhaustion",
        function (s2t) {
          var testIterator1 = {
            next: function () {
              return {
      ...
      t.test(
        "test262: test/built-ins/Iterator/concat/return-is-not-forwarded-before-initial-start",
        function (s2t) {
          var testIterator1 = {
            next: function () {
              return {
      ...
      st.test(
        "test262: test/built-ins/Iterator/concat/return-method-called-with-zero-arguments",
        function (s2t) {
          var returnCalled = 0;
      ...
      st.test(
        "test262: test/built-ins/Iterator/concat/throws-typeerror-when-generator-is-running-next",
        function (s2t) {
          var enterCount = 0;
  ...
  shimmed: function () {
    test("Iterator.concat: shimmed", function (t) {
      t.test("Function name", { skip: !functionsHaveNames }, function (st) {
        st.equal(
          Iterator.concat.name,
          "concat",
          'Iterator.concat has name "concat"',
        );
        st.end();
      });
      ...
      t.test(
        ...
        function (et) {
          et.equal(
            false,
            isEnumerable.call(Iterator, "concat"),
            "Iterator.concat is not enumerable",
          );
          et.end();
        },
      );
      ...
      module.exports.tests(
        callBind(Iterator.concat, Iterator),
        "Iterator.concat",
        t,
      );
