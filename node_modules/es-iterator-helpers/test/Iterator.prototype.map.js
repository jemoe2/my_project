...
module.exports = {
  tests: function (map, name, t) {
    ...
    forEach(v.primitives.concat(v.objects), function (nonIterator) {
      t["throws"](
        function () {
          iterate(map(nonIterator, function () {}));
        },
        TypeError,
    ...
    t.test("actual iteration", { skip: !hasSymbols }, function (st) {
      ...
      st["throws"](
        function () {
          return new map(iterator(), function () {});
        }, // eslint-disable-line new-cap
        TypeError,
        "`" + name + "` iterator is not a constructor",
      );
      ...
      st.test("generators", { skip: generators.length === 0 }, function (s2t) {
        forEach(generators, function (gen) {
          s2t.doesNotThrow(
            ...
            "generator function " +
              debug(gen) +
              " does not need to be from-wrapped first",
          );
        });
  ...
  shimmed: function () {
    test("Iterator.prototype." + fnName + ": shimmed", function (t) {
      t.equal(
        typeof Iterator.prototype[fnName],
        "function",
