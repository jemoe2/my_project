...
module.exports = {
  tests: function (proto, name, t) {
    ...
    t.test("Symbol.iterator", { skip: !hasSymbols }, function (st) {
      ...
      st.equal(
        proto[Symbol.iterator].call($Iterator),
        $Iterator,
        "function returns receiver",
      );
    ...
    t.test(
      "Symbol.toStringTag",
      {
        skip:
          !hasToStringTag ||
          "temporarily skipped pending https://bugs.chromium.org/p/chromium/issues/detail?id=1477372",
      },
      function (st) {
        st.equal(
          proto[Symbol.toStringTag],
          "Iterator",
          "has a `Symbol.toStringTag` property",
        );
    ...
    test("Iterator.prototype: shimmed", function (t) {
      t.test(
        ...
        function (et) {
          et.equal(
            false,
            isEnumerable.call(Iterator, "prototype"),
            "Iterator.prototype is not enumerable",
          );
          et.end();
        },
      );
