...
var data = {
  ...
  fontcolor: {
    arg: 'blue"red"green',
    expected: '<font color="blue&quot;red&quot;green">foo</font>',
  },
  fontsize: {
    arg: '10"large"small',
    expected: '<font size="10&quot;large&quot;small">foo</font>',
  },
  italics: "<i>foo</i>",
  link: {
    arg: 'url"http://"',
    expected: '<a href="url&quot;http://&quot;">foo</a>',
  },
...
module.exports = function (method, name, t) {
  ...
  var actual =
    typeof result === "string" ? method("foo") : method("foo", result.arg);
