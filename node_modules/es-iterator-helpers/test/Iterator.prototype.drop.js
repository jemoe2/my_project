  ...
  tests: function (drop, name, t) {
    ...
    t.test(
      ...
      function (st) {
        ...
        st.deepEqual(effects, ["ToNumber limit", "get next"]);
        st.end();
      },
    );
    ...
    t.test(
      "262: test/built-ins/Iterator/prototype/drop/get-return-method-throws",
      { skip: !hasPropertyDescriptors },
      function (st) {
        var badIterator = {
          next: function next() {
    ...
    t.test(
      ...
      function (st) {
        ...
        var iter3 = drop(
          drop(drop(drop(drop(makeBadIterator(), 1), 1), 1), 1),
          1,
        );
