...
module.exports = {
  tests: function (forEach, name, t) {
    ...
    forEachNormal(v.primitives.concat(v.objects), function (nonIterator) {
      t["throws"](
        function () {
          iterate(forEach(nonIterator, function () {}));
        },
        TypeError,
      ...
      t["throws"](
        function () {
          iterate(forEach(badNext, function () {}));
        },
        TypeError,
    ...
    forEachNormal(v.nonFunctions, function (nonFunction) {
      t["throws"](
        function () {
          forEach({ next: function () {} }, nonFunction);
        },
        TypeError,
    ...
    t.test("actual iteration", { skip: !hasSymbols }, function (st) {
      ...
      st["throws"](
        function () {
          return new forEach(iterator(), function () {});
        }, // eslint-disable-line new-cap
        TypeError,
        "`" + name + "` iterator is not a constructor",
      );
      ...
      var results = [];
      var ret = forEach(iterator(), function (x, i) {
