...
module.exports = {
  tests: function (some, name, t) {
    ...
    forEach(v.primitives.concat(v.objects), function (nonIterator) {
      t["throws"](
        function () {
          iterate(some(nonIterator, function () {}));
        },
        TypeError,
    ...
    forEach(v.nonFunctions, function (nonFunction) {
      t["throws"](
        function () {
          some({ next: function () {} }, nonFunction);
        },
        TypeError,
    ...
    t.test("actual iteration", { skip: !hasSymbols }, function (st) {
      ...
      st["throws"](
        function () {
          return new some(iterator(), function () {});
        }, // eslint-disable-line new-cap
        TypeError,
        "`" + name + "` iterator is not a constructor",
      );
      ...
      st.equal(
        ...
        true,
        "some for always-true",
      );
      st.equal(
        some(iterator(), function (x, i) {
          return x === 2 && i === 1;
        }),
        true,
        "some returns true for matching value/index",
      );
