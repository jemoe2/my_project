...
module.exports = {
  tests: function (from, name, t) {
    ...
    t.test("actual iteration", { skip: !hasSymbols }, function (st) {
      ...
      st.test(
        "__proto__ is Iterator.prototype",
        { skip: !hasProto },
        function (s2t) {
          var fakeIterator = {
            __proto__: iterProto,
          ...
          s2t.ok(
            fakeIterator instanceof $Iterator,
            "is an instanceof Iterator",
          );
          s2t.equal(
            typeof fakeIterator.next,
            "function",
            "fake iterator `.next` is a function",
          );
          s2t.equal(
            from(fakeIterator),
            fakeIterator,
            "returns input when it is an instanceof Iterator",
          );
      ...
      st.test("real iterators", { skip: !hasSymbols }, function (s2t) {
        ...
        var arrayIterHasIterProto =
          hasProto && iter.__proto__.__proto__ !== Object.prototype;
        s2t.equal(from(iter), iter, "array iterator becomes itself", {
          skip:
            !arrayIterHasIterProto &&
            "node 0.12 - 3 do not have Iterator.prototype in the proto chains",
        });
    ...
    test("Iterator.from: shimmed", function (t) {
      ...
      t.test(
        ...
        function (et) {
          et.equal(
            false,
            isEnumerable.call(Iterator, "from"),
            "Iterator.from is not enumerable",
          );
          et.end();
        },
      );
      ...
      module.exports.tests(
        callBind(Iterator.from, Iterator),
        "Iterator.from",
        t,
      );
