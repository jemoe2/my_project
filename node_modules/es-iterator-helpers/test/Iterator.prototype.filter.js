...
module.exports = {
  tests: function (filter, name, t) {
    ...
    forEach(v.primitives.concat(v.objects), function (nonIterator) {
      t["throws"](
        function () {
          iterate(filter(nonIterator, function () {}));
        },
        TypeError,
      ...
      t["throws"](
        function () {
          iterate(filter(badNext, function () {}));
        },
        TypeError,
    ...
    forEach(v.nonFunctions, function (nonFunction) {
      t["throws"](
        function () {
          filter({ next: function () {} }, nonFunction);
        },
        TypeError,
    ...
    t.test("actual iteration", { skip: !hasSymbols }, function (st) {
      ...
      st["throws"](
        function () {
          return new filter(iterator(), function () {});
        }, // eslint-disable-line new-cap
        TypeError,
        "`" + name + "` iterator is not a constructor",
      );
      ...
      testIterator(
        ...
        [1, 2, 3],
        st,
        "filter for always-true",
      );
      testIterator(
        filter(iterator(), function (x, i) {
          return x === 2 && i === 1;
        }),
        [2],
        st,
        "filter returns value for matching value/index",
      );
    ...
    t.test(
      "262: test/built-ins/Iterator/prototype/filter/predicate-args",
      function (st) {
        var g = function g() {
          var arr = ["a", "b", "c"];
          var i = 0;
        ...
        var iter = filter(g(), function (value, count) {
          if (value === "a") {
    ...
    t.test(
      "262: test/built-ins/Iterator/prototype/filter/predicate-throws",
      function (st) {
        var returnCalls = 0;
    ...
    t.test(
      "262: test/built-ins/Iterator/prototype/filter/predicate-throws-then-closing-iterator-also-throws",
      function (st) {
        var iter = {
          next: function next() {
            return {
    ...
    t.test(
      "262: test/built-ins/Iterator/prototype/filter/get-return-method-throws",
      { skip: !hasPropertyDescriptors },
      function (st) {
        var badIterator = {
          next: function next() {
        ...
        var iter = filter(badIterator, function () {
          return true;
        });
        iter.next();
    ...
    t.test(
      "262: test/built-ins/Iterator/prototype/drop/return-is-forwarded",
      function (st) {
        var returnCount = 0;
        ...
        var iter1 = filter(badIterator, function () {
          return false;
        });
    ...
    t.test(
      "262: test/built-ins/Iterator/prototype/drop/return-is-not-forwarded-after-exhaustion",
      { skip: !hasPropertyDescriptors },
      function (st) {
        ...
        var iter1 = filter(makeBadIterator(), function () {
          return true;
        });
        st["throws"](
          function () {
        ...
        var iter2 = filter(
          filter(
            filter(makeBadIterator(), function () {
              return true;
            }),
            function () {
              return true;
