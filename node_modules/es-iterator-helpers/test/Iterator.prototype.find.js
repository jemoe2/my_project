...
module.exports = {
  tests: function (find, name, t) {
    ...
    forEach(v.primitives.concat(v.objects), function (nonIterator) {
      t["throws"](
        function () {
          iterate(find(nonIterator, function () {}));
        },
        TypeError,
    ...
    forEach(v.nonFunctions, function (nonFunction) {
      t["throws"](
        function () {
          find({ next: function () {} }, nonFunction);
        },
        TypeError,
    ...
    t.test("actual iteration", { skip: !hasSymbols }, function (st) {
      ...
      st["throws"](
        function () {
          return new find(iterator(), function () {});
        }, // eslint-disable-line new-cap
        TypeError,
        "`" + name + "` iterator is not a constructor",
      );
      ...
      st.equal(
        ...
        1,
        "find for always-true",
      );
      st.equal(
        find(iterator(), function (x, i) {
          return x === 2 && i === 1;
        }),
        2,
        "find returns value for matching value/index",
      );
