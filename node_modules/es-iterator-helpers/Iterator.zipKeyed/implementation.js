...
module.exports = function zipKeyed(iterables) {
  ...
  if (mode === "longest") {
    ...
    if (
      typeof paddingOption !== "undefined" &&
      Type(paddingOption) !== "Object"
    ) {
  ...
  forEach(allKeys, function (key) {
    ...
    if (typeof desc !== "undefined" && desc["[[Enumerable]]"] === true) {
      // step 12.c
      ...
      if (IsDataDescriptor(desc)) {
        ...
        if (!IsAccessorDescriptor(desc)) {
          throw new $TypeError(
            "Assertion failed: IsAccessorDescriptor(desc) is not true",
          ); // step 12.c.ii.1
        }
  ...
  if (mode === "longest") {
    // step 14
    if (typeof paddingOption === "undefined") {
      // step 14.a
      for (var j = 0; j < iterCount; j += 1) {
        // step 14.a.i
