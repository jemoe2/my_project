...
module.exports = function IteratorZip(iters, mode, padding, finishResults) {
  ...
  if (mode !== "shortest" && mode !== "longest" && mode !== "strict") {
    throw new $TypeError(
      '`mode` must be one of "shortest", "longest", or "strict"',
    );
  }
        ...
        if (iter === null) {
          ...
          if (iter["[[Done]]"]) {
            ...
            if (mode === "shortest") {
              ...
              // step 3.b.iii.2.d.iii
              if (i !== 0) {
                // step 3.b.iii.2.d.iii.i
                return IteratorCloseAll(
                  openIters,
                  ThrowCompletion(
                    new $TypeError("Assertion failed: `i` is not 0"),
                  ),
                ); // step 3.b.iii.2.d.iii.i.i
              }
              for (var k = 1; k < iterCount; k += 1) {
                // step 3.b.iii.2.d.iii.ii
                if (iters[k] === null) {
                  throw new $TypeError(
                    "Assertion failed: `iters[k]` is `null`",
                  ); // step 3.b.iii.2.d.iii.ii.i
                }
                try {
                  result = IteratorStep(iters[k]); // step 3.b.iii.2.d.iii.ii.ii, 3.b.iii.2.d.iii.ii.iii.ii.iv
                } catch (e) {
                  // step 3.b.iii.2.d.iii.ii.iii
                ...
                if (iters[k]["[[Done]]"]) {
                  // step 3.b.iii.2.d.iii.ii.v
                  $splice(openIters, $indexOf(openIters, iters[k]), 1); // step 3.b.iii.2.d.iii.ii.v.i
                } else {
                  // step 3.b.iii.2.d.iii.ii.vi
                  return IteratorCloseAll(
                    openIters,
                    ThrowCompletion(
                      new $TypeError("Assertion failed: `open` is not `false`"),
                    ),
              ...
              if (mode !== "longest") {
                throw new $TypeError(
                  'Assertion failed: `mode` is not "longest"',
                ); // step 3.b.iii.2.d.iv.i
              }
  ...
  var gen = CreateIteratorFromClosure(
    closure,
    "Iterator Helper",
    iterHelperProto,
    ["[[UnderlyingIterators]]"],
