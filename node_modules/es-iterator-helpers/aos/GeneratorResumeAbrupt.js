...
module.exports = function GeneratorResumeAbrupt(
  generator,
  abruptCompletion,
  generatorBrand,
) {
  if (!(abruptCompletion instanceof CompletionRecord)) {
    throw new $TypeError(
      "Assertion failed: abruptCompletion must be a Completion Record",
    );
  }
  ...
  if (state !== "suspendedYield") {
    throw new $TypeError(
      "Assertion failed: generator state is unexpected: " + state,
    ); // step 4
  }
  if (abruptCompletion.type() === "return") {
    ...
    return CreateIterResultObject(
      SLOT.get(
        generator,
        "[[CloseIfAbrupt]]",
      )(NormalCompletion(abruptCompletion.value())),
      true,
    );
  }
