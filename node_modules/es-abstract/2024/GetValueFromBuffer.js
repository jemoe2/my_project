...
module.exports = function GetValueFromBuffer(
  ...
  if (
    typeof type !== "string" ||
    typeof tableTAO.size["$" + type] !== "number"
  ) {
    throw new $TypeError(
  ...
  if (order !== "SEQ-CST" && order !== "UNORDERED") {
    throw new $TypeError(
      "Assertion failed: `order` must be either `SEQ-CST` or `UNORDERED`",
    );
  }
  ...
  if (!elementSize) {
    throw new $TypeError(
      'Assertion failed: `type` must be one of "INT8", "UINT8", "UINT8C", "INT16", "UINT16", "INT32", "UINT32", "BIGINT64", "BIGUINT64", "FLOAT32", or "FLOAT64"',
    );
  }
  ...
  var isLittleEndian =
    arguments.length > 5 ? arguments[5] : defaultEndianness === "little"; // step 8
