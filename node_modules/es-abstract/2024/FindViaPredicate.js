...
module.exports = function FindViaPredicate(
  O,
  len,
  direction,
  predicate,
  ...
  if (!isInteger(len) || len < 0) {
    throw new $TypeError(
      "Assertion failed: len must be a non-negative integer",
    );
  }
  if (
    direction !== "ascending" &&
    ...
    throw new $TypeError(
      "Assertion failed: direction must be ~ASCENDING~ or ~DESCENDING~",
    );
  }
  ...
  for (
    // steps 2-4
    var k =
      direction === "ascending" || direction === "ASCENDING" ? 0 : len - 1;
