...
var basicWordChars =
  "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_"; // step 1
...
module.exports = function WordCharacters(rer) {
  ...
  if (
    (!rer["[[Unicode]]"] || !rer["[[IgnoreCase]]"]) &&
    extraWordChars.length > 0
  ) {
    throw new $TypeError(
      "Assertion failed: `extraWordChars` must be empty when `rer.[[IgnoreCase]]` and `rer.[[Unicode]]` are not both true",
    ); // step 3
  }
