...
module.exports = function DefineMethodProperty(
  homeObject,
  key,
  closure,
  enumerable,
  ...
  if (!isPropertyKey(key)) {
    throw new $TypeError(
      "Assertion failed: `key` is not a Property Key or a Private Name",
    );
  }
  ...
  if (!IsExtensible(homeObject)) {
    throw new $TypeError(
      "Assertion failed: `homeObject` is not an ordinary, extensible object, with no non-configurable properties",
    );
  }
