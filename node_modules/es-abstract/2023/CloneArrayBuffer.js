...
module.exports = function CloneArrayBuffer(
  srcBuffer,
  srcByteOffset,
  srcLength,
  cloneConstructor,
  ...
  if (!isArrayBuffer(srcBuffer)) {
    throw new $TypeError(
      "Assertion failed: `srcBuffer` must be an ArrayBuffer instance",
    );
  }
  if (!isInteger(srcByteOffset) || srcByteOffset < 0) {
    throw new $TypeError(
      "Assertion failed: `srcByteOffset` must be a non-negative integer",
    );
  }
  if (!isInteger(srcLength) || srcLength < 0) {
    throw new $TypeError(
      "Assertion failed: `srcLength` must be a non-negative integer",
    );
  }
  if (!IsConstructor(cloneConstructor)) {
    throw new $TypeError(
      "Assertion failed: `cloneConstructor` must be a constructor",
    );
  }
  ...
  /*
    ...
    */
  var targetBuffer = arrayBufferSlice(
    srcBuffer,
    srcByteOffset,
