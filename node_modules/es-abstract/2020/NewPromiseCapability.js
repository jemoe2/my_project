...
module.exports = function NewPromiseCapability(C) {
  ...
  var promise = new C(function (resolve, reject) {
    // steps 4-5
    if (
      typeof resolvingFunctions["[[Resolve]]"] !== "undefined" ||
      typeof resolvingFunctions["[[Reject]]"] !== "undefined"
    ) {
  ...
  if (
    !IsCallable(resolvingFunctions["[[Resolve]]"]) ||
    !IsCallable(resolvingFunctions["[[Reject]]"])
  ) {
    throw new $TypeError(
      "executor must provide valid resolve and reject functions",
    ); // steps 7-8
  }
