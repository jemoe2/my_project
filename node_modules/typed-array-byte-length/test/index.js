...
test("not arrays", function (t) {
  ...
  t.equal(
    false,
    typedArrayByteLength(/a/g),
    "regex literal is not typed array",
  );
  t.equal(
    false,
    typedArrayByteLength(new RegExp("a", "g")),
    "regex object is not typed array",
  );
  t.equal(
    false,
    typedArrayByteLength(new Date()),
    "new Date() is not typed array",
  );
  ...
  t.test("strings", function (st) {
    st.equal(
      false,
      typedArrayByteLength("foo"),
      "string primitive is not typed array",
    );
    st.equal(
      false,
      typedArrayByteLength(Object("foo")),
...
test("Arrow functions", { skip: !arrowFn }, function (t) {
  t.equal(
    false,
    typedArrayByteLength(arrowFn),
    "arrow function is not typed array",
  );
  t.end();
});
