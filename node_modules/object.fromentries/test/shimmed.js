...
test("shimmed", function (t) {
  ...
  t.test("Function name", { skip: !functionsHaveNames }, function (st) {
    st.equal(
      ...
      "fromEntries",
      'Object.fromEntries has name "fromEntries"',
    );
    st.end();
  });
  ...
  t.test(
    ...
    function (et) {
      et.equal(
        false,
        isEnumerable.call(Object, "fromEntries"),
        "Object.fromEntries is not enumerable",
      );
      et.end();
    },
  );
  ...
  t.test("does not mutate global method", function (st) {
    ...
    st.equal(
      "getPolyfill" in Object.fromEntries,
      false,
      '"getPolyfill" is not present',
    );
    st.equal(
      "implementation" in Object.fromEntries,
      false,
