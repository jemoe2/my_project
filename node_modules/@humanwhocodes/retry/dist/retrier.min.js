  ...
  #a(t, { signal: r, promise: i, resolve: s, reject: n }) {
    ...
    return o && "function" == typeof o.then
      ? (this.#r++,
        ...
        Promise.resolve(o)
          .then(
            (t) => (e("Function called successfully without retry."), s(t), i),
          )
          .catch((o) => {
            if (!this.#o(o)) return n(o), i;
            const c = new RetryTask(t, o, s, n, r);
            return (
              e(`Function failed, queuing for retry with task ${c.id}.`),
              this.#e.push(c),
              r?.addEventListener("abort", () => {
                e(`Task ${c.id} was aborted due to AbortSignal.`), n(r.reason);
              }),
              this.#g(),
              i
            );
