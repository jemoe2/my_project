...
test("shimUnscopables", function (t) {
  ...
  forEach(v.nonStrings, function (notNonEmptyString) {
    t["throws"](
      function () {
        shimUnscopables(notNonEmptyString);
      },
      TypeError,
  ...
  t.test(
    "symbols, no unscopables",
    { skip: typeof Symbol !== "function" || Symbol.unscopables },
    function (st) {
      st.deepEqual(Object.getOwnPropertySymbols(Array.prototype), [
        Symbol.iterator,
      ]);
  ...
  t.test(
    ...
    function (st) {
      ...
      st.notOk(
        hasOwn(Array.prototype[Symbol.unscopables], "forEach"),
        "unscopables map lacks forEach",
      );
      ...
      st.equal(
        Array.prototype[Symbol.unscopables].forEach,
        true,
        "unscopables map has forEach",
      );
