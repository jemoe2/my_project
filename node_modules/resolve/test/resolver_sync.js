...
var requireResolveSupportsPaths =
  require.resolve.length > 1 && !/^v12\.[012]\./.test(process.version); // broken in v12.0-12.2, see https://github.com/nodejs/node/issues/27794

var requireResolveDefaultPathsBroken = /^v8\.9\.|^v9\.[01]\.0|^v9\.2\./.test(
  process.version,
);
