...
module.exports = function (findLast, t) {
  ...
  t.test("empty array", function (st) {
    st.equal(
      findLast([], trueThunk),
      undefined,
      "true thunk callback yields undefined",
    );
    st.equal(
      findLast([], falseThunk),
      undefined,
      "false thunk callback yields undefined",
    );
  ...
  t.equal(
    findLast([1, 2, 3], trueThunk),
    3,
    "returns last item if findLast callback returns true",
  );
  t.equal(
    findLast([1, 2, 3], falseThunk),
    undefined,
    "returns undefined if no callback returns true",
  );
