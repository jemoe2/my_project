...
test("safe-array-concat", function (t) {
  ...
  t.equal(
    ...
    "has a length of " +
      (boundFnsHaveConfigurableLengths
        ? 1
        : "0 (function lengths are not configurable)"),
  );

  t.deepEqual(
    // eslint-disable-next-line no-extra-parens
    safeConcat(
      /** @type {(string | number | number[])[]} */ ([1, 2]),
      [3, 4],
      "foo",
      5,
      6,
  ...
  t.test(
    "has isConcatSpreadable",
    { skip: !isConcatSpreadable },
    function (st) {
      ...
      if (isConcatSpreadable) {
        ...
        st.teardown(
          mockProperty(Array.prototype, isConcatSpreadable, { value: false }),
        );
