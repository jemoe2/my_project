...
test("Objects", function (t) {
  ...
  t.test(
    "Symbol.toPrimitive",
    { skip: !v.hasSymbols || !Symbol.toPrimitive },
    function (st) {
      /** @type {Coercible} */
      var overriddenObject = { toString: st.fail, valueOf: st.fail };
      overriddenObject[Symbol.toPrimitive] =
        /** @type {(hint: string) => unknown} */ function (hint) {
          return String(hint);
        };
      ...
      /** @type {Coercible} */
      var nullToPrimitive = {
        toString: v.coercibleObject.toString,
        valueOf: v.coercibleObject.valueOf,
      };
      ...
      st.test("exceptions", function (sst) {
        ...
        uncoercibleToPrimitive[Symbol.toPrimitive] =
          /** @type {(hint: string) => unknown} */ function (hint) {
            return {
              toString: function () {
                return hint;
        ...
        throwingToPrimitive[Symbol.toPrimitive] =
          /** @type {(hint: string) => unknown} */ function (hint) {
  ...
  t.test("exceptions", function (st) {
    st["throws"](
      toPrimitive.bind(null, v.uncoercibleObject),
      TypeError,
      "uncoercibleObject throws a TypeError",
    );
    st["throws"](
      toPrimitive.bind(null, v.uncoercibleObject, Number),
      TypeError,
      "uncoercibleObject with hint Number throws a TypeError",
    );
    st["throws"](
      toPrimitive.bind(null, v.uncoercibleObject, String),
      TypeError,
      "uncoercibleObject with hint String throws a TypeError",
    );

    st["throws"](
      toPrimitive.bind(null, v.uncoercibleFnObject),
      TypeError,
      "uncoercibleFnObject throws a TypeError",
    );
    st["throws"](
      toPrimitive.bind(null, v.uncoercibleFnObject, Number),
      TypeError,
      "uncoercibleFnObject with hint Number throws a TypeError",
    );
    st["throws"](
      toPrimitive.bind(null, v.uncoercibleFnObject, String),
      TypeError,
