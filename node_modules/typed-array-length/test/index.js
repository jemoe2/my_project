...
test("not arrays", function (t) {
  ...
  t.equal(
    false,
    typedArrayLength(new RegExp("a", "g")),
  ...
  t.test("strings", function (st) {
    st.equal(
      false,
      typedArrayLength("foo"),
      "string primitive is not typed array",
    );
    st.equal(
      false,
      typedArrayLength(Object("foo")),
...
test("Typed Arrays", function (t) {
  forEach(typedArrayNames, function (typedArray) {
    ...
    if (isCallable(TypedArray)) {
      ...
      t.equal(
        typedArrayLength(arr),
        length,
        "new " + typedArray + "(10) is typed array of length " + length,
      );
    } else {
