...
type ConcatTuples<Prefix extends unknown[], Suffix extends unknown[]> = [
  ...Prefix,
  ...Suffix,
];

type ReplaceThis<T, NewThis> = T extends (
  this: infer OldThis,
  ...args: infer A
) => infer R
...
> = ReceiverBound extends true
  ? (
      ...args: RemoveFromTuple<Parameters<T>, TBoundArgs["length"] & number>
    ) => ReturnType<ReplaceThis<T, TThis>>
  : (
      ...args: ConcatTuples<
        [TThis],
        RemoveFromTuple<Parameters<T>, TBoundArgs["length"] & number>
      >
    ) => ReturnType<T>;
