...
test("not arrays", function (t) {
  ...
  t.equal(
    false,
    typedArrayByteOffset(/a/g),
    "regex literal is not typed array",
  );
  t.equal(
    false,
    typedArrayByteOffset(new RegExp("a", "g")),
    "regex object is not typed array",
  );
  t.equal(
    false,
    typedArrayByteOffset(new Date()),
  ...
  t.test("strings", function (st) {
    st.equal(
      false,
      typedArrayByteOffset("foo"),
      "string primitive is not typed array",
    );
    st.equal(
      false,
      typedArrayByteOffset(Object("foo")),
