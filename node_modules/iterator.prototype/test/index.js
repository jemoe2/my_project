...
test("Iterator.prototype", function (t) {
  ...
  t.test("Symbol.iterator", { skip: !hasSymbols }, function (st) {
    ...
    var sentinel = {};
    st.equal(fn.call(sentinel), sentinel, "Symbol.iterator returns receiver");
  ...
  t.test("Array keys", { skip: typeof [].keys !== "function" }, function (st) {
    ...
    st.equal(
      ...
      {
        skip:
          grandProto === Object.prototype &&
          "this environment lacks Iterator.prototype",
      },
    );
  ...
  t.test(
    ...
    {
      skip:
        typeof Set !== "function" || typeof Set.prototype.keys !== "function",
    },
    function (st) {
